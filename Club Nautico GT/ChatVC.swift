...
class ChatVC: JSQMessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(ChatVC.addPushMessage), name: "getMessage", object: nil)
    }
    ...
    func setup() {
        ...
        self.senderDisplayName = currentUser!["nombreCompleto"] as! String
    }
    ...
    func sendMessageToParse (message: JSQMessage) {
        let messageToSend = PFObject(className: "Chat")
